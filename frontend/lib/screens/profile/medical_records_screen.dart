...
class MedicalRecordsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Medical Records', style: AppTypography.h2),
        backgroundColor: AppColors.background,
        elevation: 0,
        centerTitle: false,
      ),
      body: PageContainer(
        child: ScrollablePageLayout(
          ...
          children: [
            ...
            Text('Access all your health documents in one secure place.', style: AppTypography.bodyLarge.copyWith(color: AppColors.textSecondary)),
