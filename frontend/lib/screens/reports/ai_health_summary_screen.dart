...
class AIHealthSummaryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('AI Health Summary', style: AppTypography.h2),
        backgroundColor: AppColors.background,
        elevation: 0,
        centerTitle: false,
      ),
      body: PageContainer(
        child: ScrollablePageLayout(
          ...
          children: [
            ...
            Text('Personalized insights generated from your health records.', style: AppTypography.bodyLarge.copyWith(color: AppColors.textSecondary)),
